...
training <- training[, -which(names(training)
                              %in% c('X', 'user_name', 'raw_timestamp_part_1', 'raw_timestamp_part_2', 
...
The model was used to predict on `training.test` in order to determine out of sample error. A confusion matrix is used to compare predicted values of `classe` to the actual values.
